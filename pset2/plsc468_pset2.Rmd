...
We sort the non-stop words by frequency to identify the top five most and least "Hamiltonian" words. Results are stored in the "words" data frame. We provide the most and least Hamiltonian words produced by the FightinWords (denoted as ".fw") and the Hamilton discrimination score (denoted by ".ham")
```{r}
