...
We keep the "ID," "name" and "href" columns, which give the number, name, and website associated with each case, for ease of referral, though they will not be used for any statistical analysis.
