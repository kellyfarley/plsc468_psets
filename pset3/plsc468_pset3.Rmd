...
We use the function textProcess() to build our corpus. This function converts text to lowercase, removes punctuation, stopwords, and numbers, and stems words.
