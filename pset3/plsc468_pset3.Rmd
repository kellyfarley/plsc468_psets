...
```{r}
temp_stm = textProcessor(documents = ads$texts, metadata = ads[, 2:7]) # clean data
outs_stm = prepDocuments(temp_stm$documents, temp_stm$vocab, temp_stm$meta) # eliminates very common and very rare terms
```
