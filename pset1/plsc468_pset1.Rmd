...
We look at the top words associated with the word "state" in each the Democratic and Republican platforms. Note that there are many word pairs with a correlation approaching 1.
...
For the Democratic platforms, the word "state" is most highly associated with words related to employment (employment, farmer, financi, pay) and new initiatives (creation, provid, propos, report, research).

For the Republican platforms, the word "state" is most highly associated with words relating to law and order (abid, adhere, affirm, enforc, safety, servic), words related to family (child, children, communiti), and words related to patriotic values (courag, liberti, rights, strength).

From these highly associated words, we can understand in which context the word "state" is being used and how the party platforms may differ. Interestingly, it appears that the Democratic platform are focused on introducing new ideas, while the Republican platforms are more focused on maintaining the status quo, which does match with assumptions of the Democratic party being more progressive and the Republican party being more traditional.
